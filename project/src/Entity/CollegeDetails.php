...
class CollegeDetails
{
    ...
    #[ORM\Column(type: 'integer')]
    private ?int $college_list_id = null;
    ...
    public function getCollegeListId(): ?int
    {
        return $this->college_list_id;
    }

    public function setCollegeListId(?int $college_list_id): void
    {
        $this->college_list_id = $college_list_id;
    }
